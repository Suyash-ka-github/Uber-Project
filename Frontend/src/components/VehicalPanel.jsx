...
const VehiclePanel = (props) => {
    return (
        <div className='p-3'>
            <div className="flex">
            <h4 className='text-2xl font-semibold inline-block -scroll '>Choose a Vehicale</h4>
            <i className="ri-arrow-down-s-line text-3xl " onClick={() => { props.setVehiclePanel(false) }} ></i>
            </div>
            <div onClick={() => {
